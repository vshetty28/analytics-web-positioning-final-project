          ...
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-sm font-medium uppercase tracking-wider text-accent mb-4">
                Your Complete Road Trip Companion
              </p>
              <h1 className="font-serif text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-balance">
                Best Rest Stops America
              </h1>
              <p className="mt-6 text-lg leading-relaxed text-background/80 text-pretty">
                Discover the ultimate guide to highway rest areas, travel centers, and road trip stops 
                across the United States. Plan your perfect journey with detailed reviews, amenity 
                information, and insider tips from experienced travelers.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-serif text-3xl font-bold text-foreground sm:text-4xl">
                Find the Perfect Rest Stop
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Whether you need a quick bathroom break or a full meal with showers, 
                we help you find rest stops that match your needs.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
                  From families on summer vacations to long-haul truckers crossing the country, 
                  our comprehensive rest stop guides serve every type of road traveler. We understand 
                  that different travelers have different needs.
                </p>
        ...
        <section id="routes" className="py-16 lg:py-24 bg-background scroll-mt-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Browse our comprehensive guides organized by major interstate corridors 
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              <h2 className="font-serif text-3xl font-bold text-foreground">
                Your Ultimate Guide to Rest Stops Across America
              </h2>
              
              <p className="text-muted-foreground leading-relaxed">
                Planning a road trip across the United States requires more than just mapping your route. 
                Knowing where to stop, rest, and refuel can make the difference between an enjoyable journey 
                and an exhausting ordeal. Our comprehensive guides to the best rest stops in America help 
                you plan every aspect of your highway travel.
              </p>

              <h3 className="font-serif text-2xl font-bold text-foreground mt-8">
                Understanding Different Types of Rest Stops
              </h3>
              
              <p className="text-muted-foreground leading-relaxed">
                Not all rest stops are created equal. Understanding the differences helps you choose 
                the right stopping point for your needs:
              </p>
              ...
              <h3 className="font-serif text-2xl font-bold text-foreground mt-8">
                Why Rest Stops Matter for Safe Travel
              </h3>
              
              <p className="text-muted-foreground leading-relaxed">
                The National Highway Traffic Safety Administration estimates that drowsy driving causes 
                over 100,000 crashes annually. Taking regular breaks at quality rest stops is essential 
                for safe travel. Our guides help you identify rest stops with the amenities you need to 
                stay alert and refreshed throughout your journey.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We recommend planning rest stops every 100-150 miles or every 2 hours of driving. 
                Use our route guides to identify rest stops along your path, noting which ones offer 
                the specific amenities you need. For longer trips, identify potential overnight stops 
                that allow extended parking.
              </p>
            </article>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="font-serif text-3xl font-bold text-primary-foreground sm:text-4xl">
                Get Our Free Road Trip Planning Guide
              </h2>
              <p className="mt-4 text-lg text-primary-foreground/80">
                Download our comprehensive PDF guide with checklists, tips, and insider information 
              ...
              <form className="mt-8 flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                <input
                  ...
                  className="flex-1 rounded-lg border-0 px-4 py-3 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-accent"
                />
